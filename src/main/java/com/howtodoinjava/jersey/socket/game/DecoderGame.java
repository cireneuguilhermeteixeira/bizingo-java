...
public class DecoderGame implements Text<Move> {

    private final static Logger logger = Logger.getLogger(DecoderGame.class.getName());
    ...
    public Move decode(String s) {
        ...
        try {
            return objectMapper.reader(Move.class).readValue(s);
        } catch (IOException e) {
